...
export default function TopRatedMoviesPage() {
  ...
  const { movies, totalPages, isLoading, error } = useTopRatedMovies(
    currentPage,
    genreId,
    year
  );
  ...
  return (
    <>
      ...
      <section id='top-rated-movies' className='container py-12 px-7'>
        <h2 className='mb-8 text-center text-3xl font-bold'>Top Rated Movies</h2>
